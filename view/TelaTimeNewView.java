...
import controller.time.TelaTimeNewController;
import models.KanbanModel;

public class TelaTimeNewView implements Observer {

    private KanbanModel model;
    private TelaTimeNewController controller;

    public void init(KanbanModel model) {
        if (model != null) {
            this.model = model;
            // O Controller precisará de lógica para distinguir ID de Opção
            controller = new TelaTimeNewController();
